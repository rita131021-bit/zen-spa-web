...
export default function ReservasSection() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      trackEvent("reserva_iniciada", { servicio: selectedSvc?.label ?? service, categoria: category, local: isGuarderia ? "Juan Báez al final" : "Villaguay al 1000" });
      ...
      trackEvent("reserva_confirmada", { servicio: selectedSvc?.label ?? service, categoria: category, local: localName, fecha: toYMD(selectedDate), hora: selectedHour });
      setSubmitted(true);
